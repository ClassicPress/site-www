...
function wpb_author_info_box( $content ) {
	...
	// Exclude Classic Commerce products. Other special pages like cart and
	// checkout are already excluded from this logic, TODO why?
	...
	if ( ! empty( $user_description ) && ( ! empty( $display_name ) ) ) {
		...
		$author_details .= '<div class="author_details">' . get_avatar( get_the_author_meta('user_email') , 90, '' , 'Avatar for ' . $display_name );
		$author_details .= nl2br( '<div class="authtext"><h5 class="author_name">About ' . $display_name . '</h5><p>'.$user_description.'</p>' );
