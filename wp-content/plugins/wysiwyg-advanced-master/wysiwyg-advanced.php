<?php
/*
Plugin Name: WYSIWYG Advanced
Plugin URI: https://github.com/johnalarcon/wysiwyg-advanced/
Description: Advanced WYSIWYG editor for ClassicPress; a pre-Gutenberg fork of TinyMCE Advanced.
Enables advanced features and plugins in TinyMCE, the visual editor in ClassicPress.
Version: 0.1.0
Author: Code Potent
License: GPL2
License URI: https://www.gnu.org/licenses/gpl-2.0.html
Text Domain: wysiwyg-advanced
Domain Path: /langusage

	WYSIWYG Advanced is free software: you can redistribute it and/or modify
	it under the terms of the GNU General Public License as published by
	the Free Software Foundation, either version 2 of the License, or
	any later version.

	WYSIWYG Advanced is distributed in the hope that it will be useful,
	but WITHOUT ANY WARRANTY; without even the implied warranty of
	MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the
	GNU General Public License for more details.

	You should have received a copy of the GNU General Public License along
	with WYSIWYG Advanced. If not, see https://www.gnu.org/licenses/gpl-2.0.html.
...
class Wysiwyg_Advanced {
	...
	public function set_paths() {
		if ( ! defined( 'WYSIWYG_URL' ) ) {
			define( 'WYSIWYG_URL', plugin_dir_url( __FILE__ ) );
		}

		if ( ! defined( 'WYSIWYG_PATH' ) ) {
			define( 'WYSIWYG_PATH', plugin_dir_path( __FILE__ ) );
		}
	}

	public function load_textdomain() {
	    load_plugin_textdomain( 'wysiwyg-advanced', false, 'wysiwyg-advanced/language' );
	}

	public function enqueue_scripts( $page ) {
		if ( 'settings_page_wysiwyg-advanced' == $page ) {
			$this->set_paths();
	...
	public function warn_if_unsupported() {
		if ( ! $this->check_minimum_supported_version() ) {
			...
			printf( __( 'WYSIWYG Advanced requires ClassicPress version %1$s or newer. It appears that you are running %2$s. This can make the editor unstable.', 'wysiwyg-advanced' ),
			...
			printf( __( 'Please upgrade your ClassicPress installation or download an <a href="%s">older version of the plugin</a>.', 'wysiwyg-advanced' ),
				'https://github.com/johnalarcon/wysiwyg-advanced/'
			);
	...
	public function settings_page() {
		...
		$this->set_paths();
		include_once( WYSIWYG_PATH . 'wysiwyg-admin.php' );
	}

	public function add_menu() {
		add_options_page( 'WYSIWYG Settings', 'WYSIWYG', 'manage_options', 'wysiwyg-advanced', array( $this, 'settings_page' ) );
	}
	...
	public function add_settings_link( $links, $file ) {
		if ( $file === 'wysiwyg-advanced/wysiwyg-advanced.php' && current_user_can( 'manage_options' ) ) {
			$settings_link = sprintf( '<a href="%s">%s</a>', admin_url( 'options-general.php?page=wysiwyg-advanced' ), __( 'Settings', 'wysiwyg-advanced' ) );
