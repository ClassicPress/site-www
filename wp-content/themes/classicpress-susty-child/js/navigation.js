...
function toggleSubMenu(parentMenuItem, forceToggle) {
    ...
    if (parentMenuItemToggled) {
        ...
        toggleButton.setAttribute('aria-label', sustyScreenReaderText.expand);
        ...
        toggleButton.setAttribute('aria-label', sustyScreenReaderText.collapse);
    }
}
...
function getDropdownButton() {
    ...
    dropdownButton.setAttribute('aria-label', sustyScreenReaderText.expand);
